...
sudo adduser --system --quiet --shell=/bin/bash --home=$PATHBASE --gecos 'EAGLE1164' --group $OE_USER
...
sudo git clone --depth 1 --branch $VERSION https://github.com/ShaheenHossain/eagle11 $PATHBASE/$VERSION/$OE_USER
