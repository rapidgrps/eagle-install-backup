...
# Execute the script to install eagle9:
# ./eagle9-install
################################################################################
...
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE0959' --group $OE_USER
...
# Specify an alternate config file (Default: /etc/eagle-server.conf).
