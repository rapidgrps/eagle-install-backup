...
#Set the default eagle1077 port (you still have to use -c /etc/odoo-server.conf for example to use this.)
OE_PORT="8077"
...
echo -e "\n---- Creating the EAGLE1077 PostgreSQL User  ----"
...
if [ $INSTALL_WKHTMLTOPDF = "True" ]; then
  echo -e "\n---- Install wkhtml and place shortcuts on correct place for EAGLE1077 ----"
...
echo -e "\n---- Create EAGLE1077 system user ----"
sudo adduser --system --quiet --shell=/bin/bash --home=$OE_HOME --gecos 'EAGLE1077' --group $OE_USER
